...
### Buildify-AI
AI-powered website builder that turns natural-language prompts into functional React websites.

*React &middot; Node.js &middot; Express &middot; MongoDB &middot; Gemini &middot; WebContainer*

<br>

### QOTD API
REST API for quote management with API-key authentication, usage tracking, and an admin interface.

*Node.js &middot; Express &middot; MongoDB &middot; React*

<br>

### Bros Cafe
Simple QR-accessible college canteen menu with admin CRUD for menu items and prices.

*React &middot; Node.js &middot; Express &middot; MongoDB*  
[View Live](https://bros-cafe.vercel.app/)
...
[Portfolio](https://iamkrishthakkar.vercel.app/) &middot; [LinkedIn](https://www.linkedin.com/in/krish-thakkar-7726452aa/) &middot; [GitHub](https://github.com/IAmKrishThakkar)
